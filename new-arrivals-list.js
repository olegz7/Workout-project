class NewArrivalsList {
  constructor(cart) {
    ...
    this.productService = new ArrivalsService();
  ...
  async renderProducts() {
    ...
    [...products]
      .sort( (a, b) => this.sortDirection === 'ascending' 
                         ...
                         : b.price - a.price)
      .forEach(product => {
          newArrivalsListDomString += `<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
    ...
    this.container.innerHTML = newArrivalsListDomString;
  }
  ...
  async handleProductInfoClick(event) {
    ...
    const productImg = modal.querySelector('.modal-body .img-top');
